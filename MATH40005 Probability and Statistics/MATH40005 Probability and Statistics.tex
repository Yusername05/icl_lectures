...
\def\syllabus{Basic set theory and combinatorics, Kolmogorov probability axioms, DRVs, CRVs, Transformations, Expectaction, Variance, Multivariate calculus, Joint Distributions, LOTUS, pgfs, mgfs, conditional distribution, central tendency, hypothesis testing, statistical models, Bayesian inference, Bootstrap}
\def\thm{subsection}
