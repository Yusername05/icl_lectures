...
\begin{definition}[Conditional probability measure]
    Consider the probability space $(\Omega, \FFF, \text{P})$ and some event $B \in \FFF$ with $\text{P}(B) > 0$, we construct the probability measure $\text{Q}$ on $(\Omega, \FFF)$ by \[
        \text{Q}(A):=\frac{P(A\cap B)}{P(B)}\textcolor{black}{.}
    \]
...
\begin{theorem}[Bayes' rule]
    For $A,B \in \FFF$ with $\text{P}(A) >0, \text{P}(B) > 0$ we have, \[
...
\begin{theorem}[Total probability]
    Given some partition $\{B_i, i\in\III\}$ of $\Omega$ with $\text{P}(B_i)>0$ for all $i\in\III$ and some event $A\in\FFF$,\[
        \text{P}(A)=\sum_{i\in\III}\text{P}(A\cap B_i)=\sum_{i\in\III}\text{P}(A|B_i)\text{P}(B_i)\textcolor{black}{.}
    \]
\end{theorem}
\endgroup
...
\begin{theorem}[Bayes' rule with extra conditioning]
    For events $A,B,E \in \FFF$ with $\text{P}(A\cap E)>0, P(B\cap E) > 0$ we have \[
    \text{P}(A|B\cap E) = \frac{\text{P}(B|A\cap E)\text{P}(A|E)}{\text{P}(B|E)}
    \textcolor{black}{.}
    \]
\end{theorem}
\endgroup
...
\begin{theorem}[Total probability with extra conditioning]
    Given events $A,E\in\III$  with $\text{P}(E)>0$ and some partition $\{B_i, i\in\III\}$ of $\Omega$ with $\text{P}(B_i\cap E)>0$ for all $i\in\III$,
    \[
        \text{P}(A|E)=\sum_{i\in\III}\frac{\text{P}(A\cap B_i\cap E)}{\text{P}(E)}
        =\sum_{i\in\III}\text{P}(A|B_i\cap E)\text{P}(B_i| E)
        \textcolor{black}{.}
    \]
\end{theorem}
\endgroup
...
Two events $A,B\in\FFF$ will be independent iff the occurrence of one does not effect the probability the other occurs, i.e $\text{P}(A|B) = \text{P}(A)$ and vice versa.

\begin{definition}[Independent events]
    Two events $A,B \in \FFF$ are said to be \textbf{independent} iff\[
    \text{P}(A\cap B) = \text{P}(A)\text{P}(B) \textcolor{black}{,}
...
\begin{definition}[General independence]
    A finite collection of events $\{A_1,A_2,\dots ,A_n\}$ is independent iff \[
    \text{P}(A_1\cap A_2\cap \dots \cap A_n) = \text{P}(A_1)\text{P}(A_2)\dots \text{P}(A_n)\textcolor{black}{,}
    \]
...
\subsection{Conditional indepence}
