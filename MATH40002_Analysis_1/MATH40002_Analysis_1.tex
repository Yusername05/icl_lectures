...
\lhead{MATH40002 Analysis}
Lectured by Dr Ajay Chandra \\ Typed by Yu Coughlin \\
...
\begin{itemize}
\item M W Liebeck, A concise intro to pure mathematics, 2016
\item F M Hart, Guide to analysis, 2001
\item D A Brannan, A first course in mathematical a analysis, 2006
\item K G Binmore, Mathematical analysis: a straightforward approach, 1982
\end{itemize}

The following are supplementary reading:
\begin{itemize}
\item S R Lay, Analysis with an introduction to proof, 1994
\item S Abbott, Understandding Analysis, 2015
\end{itemize}

The following are advanced reading:
\begin{itemize}
\item M Spivak, Calculus, 2010
\item T Tao, Analysis 1, 2022
\end{itemize}
