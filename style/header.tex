...
\newtheoremstyle{mytheoremstyle}
  ...
  {\thmname{#1}\thmnumber{ #2}\if\relax\detokenize{#3}\relax\else\thmnote{ (#3)}\fi} % Theorem head spec

\theoremstyle{mytheoremstyle}
\newtheorem{mytheorem}[n]{Theorem}

\NewDocumentEnvironment{customtheorem}{O{} O{0pt}}{%
  \if\relax\detokenize{#2}\relax\else\setmytheoremdisplayskip{#2}\fi%
  \begin{mytheorem}[#1]
  \end{mytheorem}
  \if\relax\detokenize{#2}\relax\else\vspace*{\mytheoremdisplayskip}\fi%
}
